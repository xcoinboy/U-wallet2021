...
const quint64 DEFAULT_OPTIMIZATION_THRESHOLD = 10000;
...
const QVector<NodeSetting> DEFAULT_NODES_LIST = {
  {"node.urbancash.org", 57919, "/", false},
  {"node05.urbancash.org", 57919, "/", false},
  {"publicnode.urbancash.org", 57919, "/", false},
  {"node04.urbancash.org", 57919, "/", false},
  {"mobile.urbancash.org", 57919, "/", false}
};
