...
void MainWindow::setMainWindowTitle() {
  setWindowTitle(QString(tr("Urbancash Wallet %1")).arg(Settings::instance().getVersion()));
}
...
void MainWindow::createLanguageMenu(void)
{
  ...
  m_langPath = "/usr/local/share/urbancash/urbancashwallet/languages";
#else
  m_langPath = "/opt/urbancash/languages";
#endif
  QDir dir(m_langPath);
...
//  QMessageBox::information(nullptr, QObject::tr("Help"), cmdLineParser.getHelpText());
    QMessageBox *msg = new QMessageBox(QMessageBox::Information, QObject::tr("Help"),
                       ...
                       QMessageBox::Ok, this);
    msg->setInformativeText(tr("More info can be found at https://urbancash.org in Documentation section"));
...
void MainWindow::walletOpened(bool _error, const QString& _error_text) {
  if (!_error) {
    ...
    setWindowTitle(QString(tr("%1 - Urbancash Wallet %2")).arg(Settings::instance().getWalletFile()).arg(Settings::instance().getVersion()));
...
void MainWindow::createTrayIcon()
{
    ...
    QString toolTip = QString(tr("Urbancash Wallet %1")).arg(Settings::instance().getVersion());
